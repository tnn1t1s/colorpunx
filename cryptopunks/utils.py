"""Tools for working with Cryptopunk NFTs; this includes utilities for data
analysis and image preparation for training machine learning models using
Cryptopunks as training data.
...
def get_punk_attrs(id):
    ...
    details_url = f"https://www.larvalabs.com/cryptopunks/details/{id}"
    punk_page = requests.get(details_url)
